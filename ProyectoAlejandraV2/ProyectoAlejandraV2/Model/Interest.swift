...
class Interest
{
    ...
    {
        return [
            Interest(title: "Descubre las series más populares", featuredImage: UIImage(named: "f11")!, color: UIColor(red: 63/255.0, green: 71/255.0, blue: 80/255.0, alpha: 0.8)),
            Interest(title: "Próximos estrenos más esperados", featuredImage: UIImage(named: "f2")!, color: UIColor(red: 240/255.0, green: 133/255.0, blue: 91/255.0, alpha: 0.8)),
